      ...
      <td width="40%" align="left" style="vertical-align: middle;">
		  <img class="image" src="WSBanner_right_50.png" alt="Sri Namperumal" height="50" width="55"></img>
							...
							<!-- Content -->
								<section style="">
									<header class="main">
										<h2>Category Search of E-Books</h2>
									</header>
								<h4>
								<div align="left">
					...
					<!--		<a href="CategoryBookList" style='color:blue'>List By Category</a>&nbsp;&nbsp;   -->	
								...
								<table id="filtertable1" width="100%">		
									...
									<td colspan="3">
									Sub-Category (<span style="color: #F60831">Scroll up or down in this box to see full list of search options</span>) </td>
										<td width="10%">&nbsp;</td>
									</tr>
									...
									<div class="6u$ 12u$">
											<div class="select-wrapper">
												<select class="form-control" name="category" id="category">
												  ...
												  <option value="7">Stotras & Prabandhams</option>
												  <option value="8">Commentary By</option>
