	...
	if (!isset($_REQUEST["submitsearch"]))
	{
		...
		{	
			...
			*/
			if ($_REQUEST["ss"]=="Yes")
			{
			$queryselect="select * from filedata where series='Sundarasimham' order by series asc";	
			}
			if ($_REQUEST["av"]=="Yes")
			{
			...
			if ($_REQUEST["sh"]=="Yes")
			{
			$queryselect="select * from filedata where series='Sri Hayagrivan' order by series asc";	
			}
			if ($_REQUEST["am"]=="Yes")
			{
			$queryselect="select * from filedata where series='Alamelumanga' order by series asc";	
			}		
			if ($_REQUEST["gd"]=="Yes")
			{
			$queryselect="select * from filedata where series='Godha' order by series asc";	
			}
			$selectresult=mysqli_query($conn,$queryselect);
      ...
      <td width="40%" align="left" style="vertical-align: middle;">
		  <img class="image" src="WSBanner_right_50.png" alt="Sri Namperumal" height="50" width="55"></img>
							...
							<!-- Content -->
								<section style="">
									<header class="main">
										<h2>Series Search of E-Books</h2>
									</header>
								<h4>
								<div align="left">
								For E-Books Search by Series check the boxes below and click on Search.  To go to other Search options click on links below.<br>
					...
					<!--		<a href="SearchBySeries" style='color:blue'>List By Series</a>&nbsp;&nbsp;		-->								
								...
								<table id="filtertable1" >		
									...
									<input type="checkbox" value="Yes" id="ss" name="ss">
									<label for="ss">Sundarasimham</label>
									</div>
									</td>
											
									<td  nowrap>
									<div class="6u$ 12u$(small)">
									<input type="checkbox" value="Yes" id="av" name="av">
									<label for="av">Ahobilavalli</label>
									</div>									
									</td>
								
									<td  nowrap>
									<div class="6u$ 12u$(small)">
									<input type="checkbox" value="Yes" id="sh" name="sh">
									<label for="sh">Sri Hayagrivan</label>
									</div>
									</td>
									...
									<td  nowrap>		
									<div class="6u$ 12u$(small)">
									<input type="checkbox" value="Yes" id="am" name="am">
									<label for="am">Alamelumanga</label>
									</div>
									</td>
										
									<td  nowrap>	
									<div class="6u$ 12u$(small)">
									<input type="checkbox" value="Yes" id="gd" name="gd">
									<label for="gd">Godha</label>
									</div>
									</td>	
								...
								<table id="filtertable2" >		
									...
									<td nowrap>
									<div class="6u$ 12u$">
									<input type="checkbox" value="Yes" id="ss2" name="ss2">
									<label for="ss2">Sundarasimham</label>
									</div>
									</td>
											
									<td  nowrap>
									<div class="6u$ 12u$">
									<input type="checkbox" value="Yes" id="av2" name="av2">
									<label for="av2">Ahobilavalli</label>
									</div>									
									</td>
									</tr>
									...
									<td  nowrap>
									<div class="6u$ 12u$">
									<input type="checkbox" value="Yes" id="sh2" name="sh2">
									<label for="sh2">Sri Hayagrivan</label>
									</div>
									</td>
									...
									<td nowrap>		
									<div class="6u$ 12u$">
									<input type="checkbox" value="Yes" id="am2" name="am2">
									<label for="am2">Alamelumanga</label>
									</div>
									</td>
									</tr>
									...
									<div class="6u$ 12u$(small)">
									<input type="checkbox" value="Yes" id="gd2" name="gd2">
									<label for="gd2">Godha</label>
									</div>
									</td>	
									</tr>
									...
									<td colspan="2" align="center">
										<input id="search2" name="search2" type="submit" value="Search" class="button special" required>&nbsp;&nbsp;&nbsp;&nbsp;
