	...
	if (!isset($_REQUEST["submitsearch"]))
	{
		...
		{	
			...
			*/
			...
			$queryselect="select * from filedata where (ebookname LIKE '%".$title1."%') order by ebookname asc";
		...
		{	
			...
			*/
			if (!empty($_REQUEST["title2"]))
			{
			$title2=$_REQUEST["title2"];

			$queryselect="select * from filedata where (ebookname LIKE '%".$title2."%') order by ebookname asc";
      ...
      <td width="40%" align="left" style="vertical-align: middle;">
		  <img class="image" src="WSBanner_right_50.png" alt="Sri Namperumal" height="50" width="55"></img>
							...
							<!-- Content -->
								<section style="">
									<header class="main">
										<h2>Title Search of E-Books</h2>
									</header>
								<h4>
								<div align="left">
								For Search by E-Book Title, enter full or part of the E-Book name and click on Search.  To go to other Search options click on links below.<br>
						...
						<!--	<a href="SearchByTitle" style='color:blue'>List By Title</a>&nbsp;&nbsp;	-->	
								...
								<table id="filtertable1" width="100%">
									...
									<input type="text" id="title" name="title" placeholder="Enter E-Book Name (full or partial) to Search" required/>
						<!--			<label for="title">Enter E-Book Name to Search</label>  -->
									</div>
									  </td>
									  <td align="center" valign="middle" width="20%" nowrap>
									  <input id="search1" name="search1" type="submit" value="Search" class="button special" required></td>
									  <td align="center" valign="middle" width="20%" nowrap>
								...
								<table id="filtertable2" width="100%">	
									<tr>
									<td align="center" valign="middle"  colspan="2" width="100%" bgcolor="#D3D3D3">
									<div class="6u$ 12u$">
										<strong>Enter E-Book Name (full or partial) to Search</strong>
									</div>
									</td>	
									</tr>
									<tr>
									<td align="center" valign="middle"  colspan="2" width="100%" nowrap>
									<div class="6u$ 12u$">
									<input type="text" id="title2" name="title2" placeholder="Enter E-Book Name" required/>
						<!--			<label for="title2">Enter E-Book Name to Search</label>  -->
									</div>
									  </td>
									  </tr>	
									  <tr>
